...
public class BigInteger extends Number implements Comparable<BigInteger> {
    ...
    //     private static final int PARALLEL_FORK_DEPTH_THRESHOLD = calculateMaximumDepth(ForkJoinPool.getCommonPoolParallelism());
    ...
    private static void toString(BigInteger u, StringBuilder sb, int radix, int digits) {
        ...
        int b = u.bitLength();
        int n = (int) Math.round(Math.log(b * LOG_TWO / logCache[radix]) / LOG_TWO - 1.0);
